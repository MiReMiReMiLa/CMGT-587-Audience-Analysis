...
OUTPUT = "../outputs/scored_sample_50_v2.csv"
...
3. View:
Scenic or environmental appeal (lake, mountains, snow, peaceful surroundings).
IMPORTANT: Do NOT treat "beautiful home" as view.

4. Coziness:
Emotional warmth, comfort, relaxing indoor experience.
IMPORTANT: This can be IMPLIED (not just explicit words like "cozy").

5. Activities:
Things to do nearby (skiing, wineries, hiking, attractions).
Also include implied exploration or trip activities.

6. Luxury:
Premium or high-end experience (design, finishes, upscale amenities).
IMPORTANT: "nice" or "beautiful" ≠ luxury.
...
- If clearly implied → assign at least 2–3 (not 0)
- Keep dimensions distinct (cozy ≠ luxury, view ≠ beauty)
